...
const WireTime = () => {
    ...
    return (
        <div className={styles.WireTime}>
            <div>
                <span className={styles.WireTime__text}>
                    {format(date, 'hh')}
                </span>
                <span
                    className={`${styles.WireTime__sep} ${
                        showColon ? '' : styles.WireTime__sep__hide
                    }`}>
                    :
                </span>
                <span className={styles.WireTime__text}>
                ...
                <span className={styles.WireTime__small}>
                    {format(date, 'aa')}
                </span>
            </div>
        </div>
